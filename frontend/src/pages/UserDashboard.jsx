...
import { FiUser, FiPhone, FiMail, FiHeadphones, FiMessageSquare } from 'react-icons/fi';
...
const UserDashboard = () => {
  ...
  <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
      ...
      <div className="flex-grow">
        ...
        <p className="text-gray-600 text-center md:text-left">Roomkartz Member</p>
      </div>
      </div>
  ...
  <div>
    ...
    <a href="tel:+919876543210" className="text-gray-900 hover:underline">
      +91 98765 43210
                ...
                {/* Action Buttons */}
            <div className=" my-4 flex flex-col sm:flex-row gap-4 justify-end">
               <motion.button
